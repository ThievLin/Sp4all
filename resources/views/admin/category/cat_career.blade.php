...
@section('content')
	<div class="row">
        <div class="col-md-12">
			...
			<h2><strong>Career Category</strong></h2>
		       @include('errors.message_error')
		</div>
	</div>
	<hr/>
  @if(Request::is('category_jobs'))
  <div class="row">
		<div class="col-md-12">
		<a href="{{url('category_jobs/create')}}" class="btn btn-primary create">
                Add New</a>
			<div class="panel panel-default">
				<div class="panel-heading">
                     List Career  Category
                </div>
	                 ...
	                 <table class="table table-striped table-bordered table-hover" id="dataTables-example">
	                        ...
	                        @foreach($category as $key => $ca)
	                            <tr>
	                                ...
	                                <td>
	                                	<a href="{{ url('category_jobs/'.$ca->id.'/edit') }}" class="btn btn-primary"><i class="fa fa-edit "></i> Edit</a>
										<a href="{{ url('category_jobs/'.$ca->id.'/deleted') }}" class="btn btn-danger"><i class="fa fa-ban"></i> Delete</a>
	                                </td>
	                            </tr>
	                    	@endforeach
	                    	@endif
...
@elseif(Request::is('category_jobs/create'))
	<div class="row">
		<div class="col-md-12">
			<form action="{{ url('category_jobs/create') }}" method="post">
			@csrf
			   <div class="col-md-11">
...
@elseif(Request::is('category_jobs/'.$cat->id.'/edit'))
<div class="row">
  <div class="col-md-12">
    <form action="{{ url('category_jobs/'.$cat->id.'/edit') }}" method="post">
    @csrf
       <div class="col-md-11">
            <div class="form-group">
              <label>Title</label>
