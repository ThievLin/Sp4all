...
@section('content')
  ...
  <div class="row">
		<div class="col-md-12">
		<a href="{{url('products-category/create')}}" class="btn btn-primary" style="margin-bottom: 15px;margin-left: 85%">
                Add New</a>
	                 ...
	                 <table class="table table-striped table-bordered table-hover" id="dataTables-example">
	                        ...
	                        @foreach($category as $key => $ca)
	                            <tr>
	                                ...
	                                <td>
	                                	<a href="{{ url('products-category/'.$ca->id.'/edit') }}" class="btn btn-primary"><i class="fa fa-edit "></i> Edit</a>
										<a href="{{ url('products-category/'.$ca->id.'/deleted') }}" class="btn btn-danger"><i class="fa fa-ban"></i> Delete</a>
	                                </td>
	                            </tr>
	                    	@endforeach
	                    	@endif
...
@elseif(Request::is('products-category/create'))
	<div class="row">
		<div class="col-md-12">
			<form action="{{ url('products-category/create') }}" method="post">
			@csrf
			   <div class="col-md-11">
              ...
              <div class="form-group">
                ...
                <select name="parent_id" class="form-control">
                  <?php $cate = App\Models\Category::where('category_type','=','product')->get(); ?>
...
@elseif(Request::is('products-category/'.$cat->id.'/edit'))
<div class="row">
  <div class="col-md-12">
    <form action="{{ url('products-category/'.$cat->id.'/edit') }}" method="post">
    @csrf
       <div class="col-md-11">
            <div class="form-group">
              <label>Title</label>
